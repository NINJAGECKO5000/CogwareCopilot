...
impl HyperPixel {
    ...
    fn init_spi0(&self) {
        /// i wouldent set a clock at all, we are the clock
        self.spi0()
            .clk()
            .modify(|_, w| unsafe { w.cdiv().bits(CLK) });
    }

    fn init_gpio(&self) {
        self.gpio().gpfsel1().modify(|_, w| w.fsel10().output());
        self.gpio().gpfsel1().modify(|_, w| w.fsel11().output());
        self.gpio().gpfsel1().modify(|_, w| w.fsel18().output());
        self.gpio().gpfsel1().modify(|_, w| w.fsel19().output());
        ...
        unsafe {
            ...
            self.gpio()
                .gpset0()
                .write_with_zero(|w| w.set19().set_bit());
        }

        // horrifying and bad
        self.gpfsel0().modify(|_, w| w.fsel0().reserved2());
        self.gpfsel0().modify(|_, w| w.fsel1().reserved2());
        self.gpfsel0().modify(|_, w| w.fsel2().reserved2());
        self.gpfsel0().modify(|_, w| w.fsel3().reserved2());
        self.gpfsel0().modify(|_, w| w.fsel4().reserved2());
        self.gpfsel0().modify(|_, w| w.fsel5().reserved2());
        self.gpfsel0().modify(|_, w| w.fsel6().reserved2());
        self.gpfsel0().modify(|_, w| w.fsel7().reserved2());
        self.gpfsel0().modify(|_, w| w.fsel8().reserved2());
        self.gpfsel0().modify(|_, w| w.fsel9().reserved2());

        self.gpfsel1().modify(|_, w| w.fsel12().reserved2());
        self.gpfsel1().modify(|_, w| w.fsel13().reserved2());
        self.gpfsel1().modify(|_, w| w.fsel14().reserved2());
        self.gpfsel1().modify(|_, w| w.fsel15().reserved2());
        self.gpfsel1().modify(|_, w| w.fsel16().reserved2());
        self.gpfsel1().modify(|_, w| w.fsel17().reserved2());

        self.gpfsel2().modify(|_, w| w.fsel20().reserved2());
        self.gpfsel2().modify(|_, w| w.fsel21().reserved2());
        self.gpfsel2().modify(|_, w| w.fsel22().reserved2());
        self.gpfsel2().modify(|_, w| w.fsel23().reserved2());
        self.gpfsel2().modify(|_, w| w.fsel24().reserved2());
        self.gpfsel2().modify(|_, w| w.fsel25().reserved2());

        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl0().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl1().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl2().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl3().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl4().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl5().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl6().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl7().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl8().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl9().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl12().none());
        self.gpio_pupdn0()
            .modify(|_, w| w.gpio_pup_pdn_cntrl13().none());
        self.gpio_pupdn0()
        ...
        self.gpio_pupdn1()
            .modify(|_, w| w.gpio_pup_pdn_cntrl16().none());
        self.gpio_pupdn1()
            .modify(|_, w| w.gpio_pup_pdn_cntrl17().none());
        self.gpio_pupdn1()
            .modify(|_, w| w.gpio_pup_pdn_cntrl20().none());
        self.gpio_pupdn1()
            .modify(|_, w| w.gpio_pup_pdn_cntrl21().none());
        self.gpio_pupdn1()
            .modify(|_, w| w.gpio_pup_pdn_cntrl22().none());
        self.gpio_pupdn1()
            .modify(|_, w| w.gpio_pup_pdn_cntrl23().none());
        self.gpio_pupdn1()
            .modify(|_, w| w.gpio_pup_pdn_cntrl24().none());
        self.gpio_pupdn1()
            .modify(|_, w| w.gpio_pup_pdn_cntrl25().none());
    }

    fn init_display(&mut self) {
        // self.start_spi0();
        //where to actually build the driver sequences
        self.write_command(0x01);
        delay(Duration::from_millis(240));
        ...
        //self.stop_spi0();
        //self.gpio().gpfsel1().modify(|_, w| w.fsel10().spi0_mosi());
        //self.gpio().gpfsel1().modify(|_, w| w.fsel11().spi0_sclk());
    }
}
