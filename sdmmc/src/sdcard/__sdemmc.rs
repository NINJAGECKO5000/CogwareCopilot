...
pub const EMMC_CONT: EMMCController = unsafe { EMMCController::new() };
...
fn timer_wait_micro(delay: u64) {
    // SAFETY: idk I just work here man
    unsafe {
        TIMER.delay_us(delay as _);
    }
...
fn tick_difference(start_time: u64, tick_count: u64) -> u64 {
    ...
    // (tick_diff * resolution().as_nanos() as u64) / 1000 // 1 ns == 1000 us
}
...
impl EMMCController {
    ...
    pub const unsafe fn new() -> Self {
        Self {
            registers: Registers::new(0x3F30_0000),
        }
    }
